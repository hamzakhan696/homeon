...
const ContactUs = () => {
  ...
  const handleUserNameChange = (e) => {
    ...
    if (!pattern.test(value)) {
      setUserNameError('Please enter a valid name (letters and spaces only)');
    } else {
      setUserNameError('');
    }
  };
  ...
  const handleSubjectChange = (e) => {
    ...
    setSubject(value);
    if (!pattern.test(value)) {
      setSubjectError('Please enter a valid subject (letters and spaces only)');
    } else {
      setSubjectError('');
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_API_URL || 'http://192.168.100.13:3002'}/admin/contact`, {
        method: 'POST',
        headers: {
        ...
        <div className="row d-flex align-items-center">
            <div className="col-lg-4 col-md-5 col-12">
                <div className="section-head m-b30">
                    ...
                    <div className="dlab-separator1">
                        </div>
                        <h6 className="title-small">CONTACT US</h6>
                        </div>
     <div className="contact-question mt-4">
        <li><i className="fas fa-map-marker-alt"></i><h4 className="title">Address</h4>
        <p>2nd Floor 61 Nishter Commercial, Bahria Town, Lahore</p></li>
        <li><i className="fas fa-envelope"></i><h4 className="title">Email</h4>
        <p>salam@homeon.pk</p></li>
        <li><i className="fa fa-phone-alt"></i><h4 className="title">Phone</h4>
        <p> 0325-5255255</p></li>
        </div>
        </div>
